...
{
    public partial class BCS_SWP391Context : DbContext
    {
        public BCS_SWP391Context()
        {
        }

        public BCS_SWP391Context(DbContextOptions<BCS_SWP391Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=HUMBLE\\NGUYENQUANGTHANH;Initial Catalog=BCS_SWP391;Persist Security Info=True;User ID=sa;Password=12345");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.Size1).IsFixedLength();
